...
chromatin_modifiers <- read.delim("~/Downloads/brca_tcga/Chromatin_modifiers.txt", header=FALSE, stringsAsFactors=FALSE)
...
```{R}
CNV_data = read.delim("~/Downloads/brca_tcga/data_CNA.txt", header = TRUE, row.names = 1, stringsAsFactors = FALSE)
CNV_data  = CNV_data[,-1]
```
...
#Rand Genes
Heatmap(Rand_RNA_Seq_Corr_df, name = "Random Genes Corr. Vals", col = color_scheme)
